<?php date_default_timezone_set('America/New_York'); ?>
      <fieldset> 
        <legend class="u__sr-only">Send Taleen a message</legend>
        ...
        <div class="form__group">
        	...
        	<textarea name="message" id="message" class="form__input--area" placeholder="Your message content" rows="5" required></textarea>
        </div>
        <input type="hidden" id="timestamp" name="timestamp" value="<?php echo date( 'YmdHis' ) ?>">
      </fieldset>

    	<div class="form__submit__group">
        <input name="reset" type="reset" id="reset" value="Clear form" class="form__submit btn">
      	<input name="submit" id="submit" type="submit" value="Submit Message" class="form__submit btn btn--primary">
    	</div>
