...
$mailer_sitetitle = 'Taleen Batalian';
$mailer_destination = 'taleen@taleenbatalian.com';
$baseurl = '/';
...
if ( count($_POST) ) {
  ...
  // If a submission comes in under 5 seconds, this is a bot trying to hit the mailer.php script externally
  if ( ($now - $timeofinput) < 5 ) {
...
//then 2022 02 26 171002
  ...
  if ( $spam === false && $postaction == 'Submit Message' ) {
    ...
    if ( mail($to, $subject, $bodyofmessage, $headers) ) {
      ...
      // print_r($_POST);
      // echo '</pre>';
      echo '<!doctype HTML><html lang="en"><head><title>Thanks for your Message | '.$mailer_sitetitle.'</title><meta charset="utf-8"><link rel="stylesheet" type="text/css" href="'.$baseurl.'assets/css/main.css"><link rel="icon" type="image/png" sizes="16x16" href="'.$baseurl.'assets/favicon-16x16.png"></head><body class="content rhythm u__vertical__p u__gutter__p"><h1>Success; your message was sent</h1><p>Thank you. Please return to the <a href="'.$baseurl.'contact/">Contact page</a> or start at the <a href="'.$baseurl.'">Homepage</a></p><hr><h2>Message synopsis</h2><p><b>Subject:</b> '.$subject.'<br><b>Sent to:</b> '.$to.'<br><b>Name:</b> '.$theirname.'<br><b>Email:</b> '.$theiremail.'</p><p><b>Message:</b><br>'.$anecdote.'</p></body></html>';
    } else {
      error_log('Mailer.php — Sending mail failed: ' . error_get_last());
      echo '<!doctype HTML><html lang="en"><head><title>No post | '.$mailer_sitetitle.'</title><meta charset="utf-8"><link rel="stylesheet" type="text/css" href="'.$baseurl.'assets/css/main.css"><link rel="icon" type="image/png" sizes="16x16" href="'.$baseurl.'assets/favicon-16x16.png"></head><body class="content rhythm u__vertical__p u__gutter__p"><h1>Sorry, the mail function failed</h1><p>We are sorry for the inconvenience. You can always send a message via good’ole email at <a href="mailto:'.$mailer_destination.'">'.$mailer_destination.'</a>. Your message as it was captured is below.</p><hr><h2>Message synopsis</h2><p><b>Your Name:</b> '.$theirname.'<br><b>Your Email:</b> '.$theiremail.'</p><p><b>Your Message:</b><br>'.$anecdote.'</p><hr><p><b>Error message:</b><br>'.error_get_last().'</p></body></html>';
    }
  } else {
    ...
    echo '<!doctype HTML><html lang="en"><head><title>Thanks | '.$mailer_sitetitle.'</title><meta charset="utf-8"><meta http-equiv="refresh" content="15;url='.$baseurl.'contact/"><link rel="stylesheet" type="text/css" href="'.$baseurl.'assets/css/main.css"><link rel="icon" type="image/png" sizes="16x16" href="'.$baseurl.'assets/favicon-16x16.png"></head><body class="content rhythm u__vertical__p u__gutter__p"><h1>Thank you</h1><p>Your message has been sent.</p></body></html>';
  }
} else {
  // No post found
  error_log('Mailer.php — No post was found at all');
  echo '<!doctype HTML><html lang="en"><head><title>No post | '.$mailer_sitetitle.'</title><meta charset="utf-8"><meta http-equiv="refresh" content="15;url='.$baseurl.'contact/"><link rel="stylesheet" type="text/css" href="'.$baseurl.'assets/css/main.css"><link rel="icon" type="image/png" sizes="16x16" href="'.$baseurl.'assets/favicon-16x16.png"></head><body class="content rhythm u__vertical__p u__gutter__p"><h1>No post found</h1><p>Incomplete form submission (required fields not supplied).</body></html>';
}
